...
export type BlackBEQueryInfoWithRespId = BlackBECommonInfo | BlackBEPrivInfoWithRespId
...
export async function getRepoByUuid(uuid: string): Promise<BlackBEPrivRespInfo | null> {
  if (uuid === '1') {
    return {
      uuid,
      name: '公有库',
